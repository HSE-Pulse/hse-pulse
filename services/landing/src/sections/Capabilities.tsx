...
const services: ServiceCardProps[] = [
  ...
  },
  {
    ...
    description: 'Generates personalised treatment pathway recommendations by encoding patient diagnosis profiles through a fine-tuned BERT classifier. 6-page dashboard with NIES patient satisfaction analytics, in-app training, and ICD code search across 195K+ codes.',
    ...
    features: [
      ...
      { icon: Search, label: 'ICD code search across 195K+ codes' },
      { icon: BarChart3, label: 'NIES 2020 patient satisfaction analytics (17+ categories)' },
    ],
    techStack: [
  ...
  },
  {
    ...
    features: [
      { icon: Activity, label: '5-feature input: trolley count, admissions, discharges, >24hr waiting, elderly waiting' },
      { icon: Calendar, label: '1-14 day autoregressive forecast with confidence intervals' },
      { icon: Building2, label: '12 Irish hospitals with real HSE area mapping' },
